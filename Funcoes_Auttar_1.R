...
###################################################################
#base_dados_1 eh o indice(use a coluna indice), 
#a base_dados_2 eh onde vai procurar o valor
###################################################################
...
#######################################################################
#segmentar por dias de transacao na base. Deve normalizar base antes.
#######################################################################
analisar_dias_base <- function(base_ativa, ano_base){
  ...
  #transforma colunas em tipo n?merico
  ...
  #calcula porcentangem de inativo em relacao ao total de inativos
  ...
  #calcula porcentangem de inativo em relacao ao total de ativos
  ...
  #calcula porcentangem de inativo em relcao ao total de ativos
...
###################################################################
#mostrar media de transacao dias entre duas bases
###################################################################
...
############################################
#normalizar base. Arrumar linhas e colunas
############################################
...
BUSCA_BASE_6 <- BUSCA_BASE_6[,-(19:20)] 

colnames(BUSCA_BASE_6) <- c("CODIGO_EMPRESA", "NOME_EMPRESA", "NUMERO_LOJA",
                            "NOME_LOJA", "CNPJ", "DATA_INCLUSAO", "QTD_TRS",
                            "VLR_TRS", "PRIMEIRA_TRS", "MES_PRIMEIRA_TRS",
                            "ULTIMA_TRS", "MES_ULTIMA_TRS", "ATIVO", "DIAS",
                            "RANGE", "POS_TEF", "QTDA_HTTPS", "SITUACAO")
